...
if ( ! function_exists( 'soul_theme_slug_sanitize_select' ) ) {
	/**
	 * Sanitize select.
	 *
	 * @deprecated 1.2.0 Use soul_customize_sanitize_select()
	 * @see soul_customize_sanitize_select()
	 *
	 * @since 0.6.11
	 *
	 ...
	 */
	function soul_theme_slug_sanitize_select( $input, $setting ) {
		_deprecated_function( __FUNCTION__, '1.2.0', 'soul_customize_sanitize_select' );
		return soul_customize_sanitize_select( $input, $setting );
	}
}
...
if ( ! function_exists( 'soul_adjust_body_class' ) ) {
	 ...
	 */
	function soul_adjust_body_class( $classes ) {
		_deprecated_function( 'soul_adjust_body_class', '0.9.4' );
		return $classes;
	}
}

if ( ! function_exists( 'soul_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function soul_slbd_count_widgets( $sidebar_id ) {

		_deprecated_function( 'soul_slbd_count_widgets', '0.8.9', 'soul_widget_classes' );
