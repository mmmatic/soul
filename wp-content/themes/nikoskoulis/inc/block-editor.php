...
add_action( 'after_setup_theme', 'soul_block_editor_setup' );

if ( ! function_exists( 'soul_block_editor_setup' ) ) {
	 ...
	 * @since 1.0.0
	 */
	function soul_block_editor_setup() {
		...
		$color_palette = soul_generate_color_palette();
		if ( $color_palette ) {
...
if ( ! function_exists( 'soul_generate_color_palette' ) ) {
	/**
	 ...
	 * @return array
	 */
	function soul_generate_color_palette() {
		$color_palette = array();
		 ...
		 */
		return apply_filters( 'soul_theme_editor_color_palette', $color_palette );
	}
}
