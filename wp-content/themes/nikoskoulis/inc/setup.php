...
if ( ! function_exists( 'soul_setup' ) ) {
	...
	function soul_setup() {
		 ...
		 * If you're building a theme based on soul, use a find and replace
		...
		register_nav_menus(
			array(
				'primary' => __( 'Main Menu', 'soul' ),
				'footer'  => __( 'Footer Menu', 'soul' ),
				'social'  => __( 'Social Menu', 'soul' )
			)
		);
		...
		soul_setup_theme_default_settings();
