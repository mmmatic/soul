...
(function (factory) {
  ...
  var Animate = class Animate {
    ...
    advance(deltaTime) {
      ...
      (_this$onUpdate = this.onUpdate) == null || _this$onUpdate.call(this, this.value, completed);
    }
    /** Stop the animation */
    stop() {
      this.isRunning = false;
  ...
  var Dimensions = class Dimensions {
    constructor(wrapper, content, {
      ...
      this.wrapperResizeObserver = void 0;
      this.contentResizeObserver = void 0;
      this.resize = () => {
  ...
  var Emitter = class Emitter {
    ...
    emit(event, ...args) {
      ...
      for (let i = 0, length = callbacks.length; i < length; i++) {
        var _callbacks$i;
        (_callbacks$i = callbacks[i]) == null || _callbacks$i.call(callbacks, ...args);
      }
    }
    /**
    ...
    on(event, cb) {
      ...
      return () => {
        ...
        this.events[event] = (_this$events$event2 = this.events[event]) == null ? void 0 : _this$events$event2.filter(i => cb !== i);
      };
    }
    /**
    ...
    off(event, callback) {
      ...
      this.events[event] = (_this$events$event3 = this.events[event]) == null ? void 0 : _this$events$event3.filter(i => callback !== i);
    }
    /**
  ...
  var Lenis = class Lenis {
    constructor({
       ...
       */
      this.targetScroll = void 0;
      /**
       * The animated scroll value
       */
      this.animatedScroll = void 0;
      ...
      this.onClick = event => {
        ...
        const anchor = path.find(node => {
          ...
          return node instanceof HTMLAnchorElement && (((_node$getAttribute = node.getAttribute("href")) == null ? void 0 : _node$getAttribute.startsWith("#")) || ((_node$getAttribute2 = node.getAttribute("href")) == null ? void 0 : _node$getAttribute2.startsWith("/#")) || ((_node$getAttribute3 = node.getAttribute("href")) == null ? void 0 : _node$getAttribute3.startsWith("./#")));
        });
        if (anchor) {
      ...
      this.onVirtualScroll = data => {
        ...
        if (!!composedPath.find(node => node instanceof HTMLElement && (typeof prevent === "function" && (prevent == null ? void 0 : prevent(node)) || (node.hasAttribute == null ? void 0 : node.hasAttribute("data-lenis-prevent")) || isTouch && (node.hasAttribute == null ? void 0 : node.hasAttribute("data-lenis-prevent-touch")) || isWheel && (node.hasAttribute == null ? void 0 : node.hasAttribute("data-lenis-prevent-wheel")) || this.options.allowNestedScroll && this.checkNestedScroll(node, {
          deltaX,
          deltaY
        })))) return;
    ...
    scrollTo(target, {
      ...
      if (typeof target === "string" && ["top", "left", "start"].includes(target)) {
        ...
        } else if (target instanceof HTMLElement && (_target = target) != null && _target.nodeType) {
          node = target;
        }
        if (node) {
    ...
    checkNestedScroll(node, {
      ...
      const time = Date.now();
      const cache = (_node$_lenis = node._lenis) != null ? _node$_lenis : node._lenis = {};
      let hasOverflowX, hasOverflowY, isScrollableX, isScrollableY, scrollWidth, scrollHeight, clientWidth, clientHeight;
      const gestureOrientation = this.options.gestureOrientation;
      if (time - ((_cache$time = cache.time) != null ? _cache$time : 0) > 2e3) {
        cache.time = Date.now();
    ...
    get actualScroll() {
      ...
      return this.isHorizontal ? (_wrapper$scrollX = wrapper.scrollX) != null ? _wrapper$scrollX : wrapper.scrollLeft : (_wrapper$scrollY = wrapper.scrollY) != null ? _wrapper$scrollY : wrapper.scrollTop;
    }
    /**
  ...
  var _config$1 = {
    ...
    */
    ...
    toArray = function toArray(value, scope, leaveStrings) {
      return _context$3 && !scope && _context$3.selector ? _context$3.selector(value) : _isString$2(value) && !leaveStrings && (_coreInitted$4 || !_wake()) ? _slice.call((scope || _doc$3).querySelectorAll(value), 0) : _isArray(value) ? _flatten(value, leaveStrings) : _isArrayLike(value) ? _slice.call(value, 0) : value ? [value] : [];
    },
  ...
  */
  ...
  gsapWithCSS.registerPlugin(SplitText, ScrollTrigger$1);
  class Loader {
    constructor() {
      var _this$loader, _this$loader2;
      this.loader = document.getElementById("loader");
      this.progress = (_this$loader = this.loader) == null ? void 0 : _this$loader.querySelector(".loader__progress");
      this.progressBar = (_this$loader2 = this.loader) == null ? void 0 : _this$loader2.querySelector(".loader__bar-fill");
      this.counterObj = {
        value: 0
      };
    }
    ...
    async trackAssetsLoading() {
      ...
      await Promise.all([new Promise(resolve => imgLoad.on("always", resolve)), Promise.all(videoPromises)]);
    ...
    showInitialElements() {
      const tl = gsapWithCSS.timeline();
      tl.set("#loader .loader__logo", {
        autoAlpha: 1
      }).set("#loader .loader__tagline", {
        autoAlpha: 1
      });
    }
    animateLogoPaths() {
    ...
    fadeInLogoName() {
      gsapWithCSS.timeline().to("#intro-nk-logo-name", {
        autoAlpha: 1,
        duration: 1,
        delay: 0.3,
        ease: "power2.out"
    ...
    animateTextMasking() {
      ...
      if (!tagline) return;
      const lines = new SplitText(tagline, {
        type: "lines"
      }).lines;
      lines.forEach(line => {
  ...
  class ImageHoverLink {
    ...
    hideImage() {
      gsapWithCSS.killTweensOf(this.DOM.revealInner);
      gsapWithCSS.killTweensOf(this.DOM.revealClip);
      gsapWithCSS.killTweensOf(this.DOM.revealImage);
      this.tl = gsapWithCSS.timeline({
        onStart: () => {
          gsapWithCSS.set(this.DOM.el, {
  ...
  class Drawer {
    constructor({
      ...
      gsapWithCSS.set(this.nav, {
        autoAlpha: 0
      });
      gsapWithCSS.set(this.navLinksInner, {
        yPercent: 100,
        autoAlpha: 0
      });
      gsapWithCSS.set(this.footer, {
        y: 20,
        autoAlpha: 0
      });

      // Drawer open/close
      this.drawer_tl = gsapWithCSS.timeline({
        paused: true,
        reversed: true
      });
      this.drawer_tl.to(this.drawer, {
        autoAlpha: 1,
        duration: 0.01
      }).to(this.bg, {
        scaleY: 1,
      ...
      this.burger_tl = gsapWithCSS.timeline({
        paused: true,
        reversed: true
      });
      this.burger_tl.to(this.line1, {
        y: 3,
        rotate: 45,
    ...
    _openDropdown(dropdown) {
      ...
      return new Promise(resolve => {
        ...
        if (!isMobile) {
          gsapWithCSS.to(dropdown._children, {
            yPercent: 0,
            autoAlpha: 1,
            duration: 0.5,
  ...
  var VanillaTilt$1 = /*@__PURE__*/getDefaultExportFromCjs(vanillaTilt);
  ...
  class HomepageGrid {
    ...
    initTitleHover() {
      this.anchors.forEach(anchor => {
        ...
        gsapWithCSS.set(anchorReveal, {
          yPercent: 25,
          autoAlpha: 0
        });
        if (!anchorReveal) return;
        anchor.addEventListener('mouseenter', () => {
          gsapWithCSS.to(anchorReveal, {
            yPercent: 0,
            autoAlpha: 1,
            duration: 0.3,
            ease: 'power2.out'
    ...
    initTiltEffects() {
      ...
      VanillaTilt$1.init(tiltElements, {
        reverse: true,
        max: 10,
        speed: 3000,
        scale: 1.05,
    ...
    animateGrid() {
      const gridItems = gsapWithCSS.utils.toArray('.homepage__grid-item');
      const itemSpeed = gsapWithCSS.utils.toArray("[data-speed]");
      gridItems.forEach(item => {
        gsapWithCSS.from(item.querySelector('.card__img img'), {
          scale: 1.5,
          filter: 'blur(2px)',
          scrollTrigger: {
            trigger: item,
            containerAnimation: ScrollTrigger$1.getAll()[0].animation,
            start: 'left right',
            end: 'left center',
            scrub: true
          }
